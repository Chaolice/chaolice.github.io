...
// //   } else {
// //     document.getElementById("header").style.fontSize = "17rem";
...
// // Get the h1 element with the class of "sticky-title"
// const title = document.querySelector(".sticky-title");

// // Get the second section
// const secondSection = document.querySelector(".one");
...
//   // Check if the user has scrolled past the second section
//   if (window.scrollY > secondSectionPosition) {
//     // If so, add the "fixed" class to the h1 element
...
allCards.forEach(function (el) {
  ...
  hammertime.on("panend", function (event) {
    ...
    //regarder si la carte a la classe wrong
    // console.log(event.target.classList);
    if (event.target.classList.contains("goLeft")) {
...
function help() {
  ...
  var a = [
    "<p>x2 LARGE EGGS</p><br>",
    "<p>1/4 CUP OF MILK</p><br>",
    "<p>x1 BUTTER</p><br>",
    "<p>x1 TBS OF SUGAR</p><br>",
    "<p>x1 SLICES OF BREAD</p><br>",
  ];

  node.innerHTML =
    '<div class="ingredientName">' + a[currentTextIndex] + "</div>";
...
//   node.innerHTML = '<div class="ingredientName">' + a[currentIndex] + "</div>";
//   q.appendChild(node);
//   currentIndex++;
...
//ADD THAT WHEN OVER IT SAYS READY AND GET RID OF GLOVE
...
// document.getElementById("addOpButton").addEventListener("click", function () {
//   currentSticker++;
//   if (currentSticker >= stickers.length) {
//     currentSticker = 0;
//   }
//   sticker.src = stickers[currentSticker];
// });

//INSTRUCTIONS AND INGREDIENTS
let ingredients = [
  '<video autoplay muted loop id=" myVideo" height="200vw"><source src="assets/VID_EGGS.MP4" type="video/mp4">Any alternate text.</video>',
  '<video autoplay muted loop id=" myVideo" height="200vw"><source src="assets/VID_EGGS.mp4" type="video/mp4">Any alternate text.</video>',
  '<video autoplay muted loop id=" myVideo" height="200vw"><source src="assets/VID_MILK.mp4" type="video/mp4">Any alternate text.</video>',
  '<video autoplay muted loop id=" myVideo" height="200vw"><source src="assets/VID_TOAST.mp4" type="video/mp4">Any alternate text.</video>',
  '<video autoplay muted loop id=" myVideo" height="200vw"><source src="assets/VID_TOAST.mp4" type="video/mp4">Any alternate text.</video>',
  '<video autoplay muted loop id=" myVideo" height="200vw"><source src="assets/VID_TOAST.mp4" type="video/mp4">Any alternate text.</video>',
];
let ingredients2 = [
  '<video autoplay muted loop id=" myVideo" height="200vw"><source src="assets/VID_BOWL.mp4" type="video/mp4">Any alternate text.</video>',
  '<video autoplay muted loop id=" myVideo" height="200vw"><source src="assets/VID_PLATE.MP4" type="video/mp4">Any alternate text.</video>',
  '<video autoplay muted loop id=" myVideo" height="200vw"><source src="assets/VID_SUGAR.MP4" type="video/mp4">Any alternate text.</video>',
  '<video autoplay muted loop id=" myVideo" height="200vw"><source src="assets/VID_BOWL.MP4" type="video/mp4">Any alternate text.</video>',
  '<video autoplay muted loop id=" myVideo" height="200vw"><source src="assets/VID_PAN.mp4" type="video/mp4">Any alternate text.</video>',
  '<video autoplay muted loop id=" myVideo" height="200vw"><source src="assets/VID_PLATE.MP4" type="video/mp4">Any alternate text.</video>',
];
let instructions = [
  "<h2>Break the eggs<br>on the edge of a bowl<br>and pour it in</h2>",
  "<h2>Beat the eggs</h2>",
  "<h2>Add in the milk and<br> the sugar,<br>then mix</h2>",
  "<h2>Dip the bread<br>in the mix and<br>let it soak</h2>",
  "<h2>Golden in the pan</h2>",
  "<h2>Set on a plate and enjoy!</h2>",
];

let nextStep = [
  '<div class="glove"><button type="button" id="addOpButton" onclick="huhu()"> <img src="assets/glove.png"></button></div>',
  '<div class="glove"><button type="button" id="addOpButton" onclick="huhu()"> <img src="assets/glove.png"></button></div>',
  '<div class="glove"><button type="button" id="addOpButton" onclick="huhu()"> <img src="assets/glove.png"></button></div>',
  '<div class="glove"><button type="button" id="addOpButton" onclick="huhu()"> <img src="assets/glove.png"></button></div>',
  '<div class="glove"><button type="button" id="addOpButton" onclick="huhu()"> <img src="assets/glove.png"></button></div>',
...
let currentIndexIngr = 0;
let currentStep = 2;

function huhu() {
  // code to add another option
  var ingredientsEl = document.getElementsByClassName("ingredients")[0];
  var ingredients2El = document.getElementsByClassName("ingredients2")[0];
  var instructionsEl = document.getElementsByClassName("instructions")[0];
  var stepNumberEl = document.getElementsByClassName("stepNumber")[0];
  var nextStepEl = document.getElementsByClassName("nextStep")[0];

  ingredientsEl.innerHTML = ingredients[currentIndexIngr];
  ingredients2El.innerHTML = ingredients2[currentIndexIngr];
  instructionsEl.innerHTML = instructions[currentIndexIngr];
  stepNumberEl.innerHTML = currentStep;
  nextStepEl.innerHTML = nextStep[currentIndexIngr];

  currentIndexIngr++;
  currentStep++;

  if (currentIndexIngr >= ingredients.length) {
    currentIndexIngr = 5;
    currentStep = 7;
    //DELETE GLOVE
  }
...
//   sticker.src = "assets/glove-smol.png";
//   sticker.classList.add("sticker");
//   sticker.style.position = "fixed";
//   var x = event.clientX - sticker.width / 2;
//   var y = event.clientY - sticker.height / 2;
//   var rotation = Math.random() * 360 + "deg"; // generates a random rotation between 0 and 360 degrees
//   var size = Math.random() * 1;
//   sticker.style.left = x + "px";
//   sticker.style.top = y + "px";
//   sticker.style.transform = "rotate(" + rotation + ")";
//   sticker.style.transform = "scale(" + size + ")";
//   document.querySelector(".six").appendChild(sticker);
// }

let zIndex = 0;
const imageUrls = [
  "assets/STICKER_01-smol.png",
  "assets/STICKER_02-smol.png",
  "assets/STICKER_03-smol.png",
];

function addSticker(event) {
  var sticker = document.createElement("img");
  var randomIndex = Math.floor(Math.random() * imageUrls.length);
  sticker.src = imageUrls[randomIndex];
  sticker.classList.add("sticker");
...
// function addSticker(event) {
//   var sticker = document.createElement("img");
//   sticker.src = "assets/STICKER_01-smol.png";
//   sticker.classList.add("sticker");
...
//   sticker.style.position = "sticky";
//   sticker.onload = function () {
//     var parentRect = document.querySelector(".six").getBoundingClientRect();
//     var x = event.pageX - parentRect.left - sticker.width / 2;
//     var y = event.pageY - parentRect.top - sticker.height / 2;
//     var rotation = Math.random() * 360 + "deg";
//     sticker.style.left = x + "px";
//     sticker.style.top = y + "px";
//     sticker.style.transform = "rotate(" + rotation + ")";
